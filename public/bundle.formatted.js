/**
 * jsproxy bundle — beautified for reading only. NOT loaded at runtime.
 * Runtime uses public/bundle.js (minified). Regenerate: npm run format:bundle
 */
! function(a) {
    var o = {};
    ...
    "onclick" in (e = self) ? function(a) {
        if (n.h(n.a), function(a) {
                try {
                    if (a === top) return !0
                } catch (a) {}
                try {
                    if (a !== a.parent && "function" == typeof a.parent.__init__) return !1
                } catch (a) {}
                return !0
            }(a)) {
            let o;
            ...
            const e = i(14);
            e.init(a), console.log("[jsproxy] shell page inited")
        } else {
            const o = a.parent;
            o.__init__(a), a.__set_srcWin = function() {
                return o.__set_srcWin(a)
            }
        }
    ...
    async function aa(a, o, i, e) {
        ...
        return "text/html" === d && "GET" === a.method ? Y(r, g, o) : new Response(r.body, g)
    }
