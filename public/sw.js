...
const VC_BUILD = '20260727-phase1-inject'
self.addEventListener('fetch', (event) => {
  const path = new URL(event.request.url).pathname
  if (
    /^\/(?:index\.html|viewer(?:\.html)?|bridge\.js|bundle\.js|conf\.js|inject\.js|sw\.js|404\.html|favicon\.ico)$/.test(
      path,
    )
  ) {
...
jsproxy_config = (x) => {
  __CONF__ = x
  __FILE__ = x.assets_cdn + 'bundle.js?b=' + VC_BUILD
